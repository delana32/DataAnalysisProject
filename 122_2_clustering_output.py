...
data = pandas.read_csv('D:\Masters\Data Analysis and Data Mining\Assignment 2\\Data\\Combined Dataset\\122_2_test.csv', delimiter = ',')

#Gets unique stop numbers from data column
#stop_unique = pandas.unique(data.Stop_ID)
stop_unique = [4523,1357, 1424,12,1384]
...
for i in range(0,len(stop_unique)):
		...
		output.to_csv('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Data\\Cluster_data\\122_2_'+str(stop_unique[i])+'.csv',sep=',')
		...
		ax1.set_title("122: The Silhouette plot for Bus Stop: "+str(stop_unique[i])+", No. Clusters: "+str(n_clusters[i])+" for Test data")
		ax1.set_xlabel("Silhouette coefficient value")
		ax1.set_ylabel("Cluster label")

		ax1.axvline(x=silhouette_avg, color="red", linestyle="--")
		
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\122_2_silhouette_plot_122_1_'+str(stop_unique[i])+'_scheduled.png', bbox_inches = 'tight')
		plt.show()
"""
