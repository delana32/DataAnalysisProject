...
# For plot of Elbow method without silhouette and clustering graphs
		...
		plt.tight_layout()
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\9_2_silhouette_plot_'+str(stop_unique[i])+'.png')
		plt.show()
		...
		plt.show()
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\9_2_elbow_plot_'+str(stop_unique[i])+'.png', bbox_inches = 'tight')
