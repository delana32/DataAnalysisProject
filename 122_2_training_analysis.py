...
# For plot of Elbow method without silhouette and clustering graphs
		...
		plt.suptitle('Silhouette Plot for Bus: 122, Stop: '+str(stop_unique[i]))
		plt.tight_layout()
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\122_2_silhouette_plot_'+str(stop_unique[i])+'.png')
		plt.show()
		...
		ax2.set_title('The Elbow method for Stop '+str(stop_unique[i]))
		ax2.set_xlabel('No. of Clusters')
		ax2.set_ylabel('Distortions')
		plt.show()
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\122_2_elbow_plot_'+str(stop_unique[i])+'.png', bbox_inches = 'tight')
