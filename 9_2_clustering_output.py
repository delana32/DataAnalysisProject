...
data = pandas.read_csv('D:\Masters\Data Analysis and Data Mining\Assignment 2\\Data\\Combined Dataset\\9_2_test.csv', delimiter = ',')

#Gets unique stop numbers from data column
#stop_unique = pandas.unique(data.Stop_ID)
stop_unique = [6228,336,2457,193,2417]

#initialising the number of clusters that each stop should be run for 
n_clusters = [2,2,2,2,2]
...
for i in range(0,len(stop_unique)):
		...
		data_training = data_training.drop('Rain_1_Hr',1)
		...
		data_test = data_test.drop('Rain_1_Hr',1)
		...
		training_final = training_merged.rename(index = str, columns={ "Scheduled_Arrival_Time": "Scheduled_Arrival_Time", "Difference": "Difference","Sound_Level":"Sound_Level","Temperature":"Temperature","Wind_Speed":"Wind_Speed","Visibility":"Visibility","Total_Rainfall":"Total_Rainfall", 0:"old_index", 1:"label"})
		...
		test_final = test_merged.rename(index = str, columns={ "Scheduled_Arrival_Time": "Scheduled_Arrival_Time", "Difference": "Difference","Sound_Level":"Sound_Level","Temperature":"Temperature","Wind_Speed":"Wind_Speed","Visibility":"Visibility","Total_Rainfall":"Total_Rainfall", 0:"old_index", 1:"label"})
		...
		#output_data.to_csv('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Data\\Cluster_data\\9_2_'+str(stop_unique[i])+'_scheduled.csv',sep=',')
		
		#Merging the training and test datasets for output
		output = output_training_data.append(output_test_data, ignore_index=True)
		output.to_csv('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Data\\Cluster_data\\9_2_'+str(stop_unique[i])+'.csv',sep=',')
		...
		plt.title('9: '+str(n_clusters[i])+' Clusters for Bus Stop '+str(stop_unique[i]))
		...
		plt.tight_layout()
		plt.show()
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\122_2_cluster_plot_'+str(n_clusters[i])+'_'+str(stop_unique[i])+'_scheduled.png', bbox_inches = 'tight')
		...
		ax1.set_title("9: The Silhouette plot for Bus Stop: "+str(stop_unique[i])+", No. Clusters: "+str(n_clusters[i])+" for Test data")
		ax1.set_xlabel("Silhouette coefficient value")
		ax1.set_ylabel("Cluster label")

		ax1.axvline(x=silhouette_avg, color="red", linestyle="--")
		
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\final_graphs\\9_1_silhouette_plot_122_1_'+str(stop_unique[i])+'_scheduled.png', bbox_inches = 'tight')
		plt.show()
"""
