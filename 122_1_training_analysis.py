...
# For plot of Elbow method without silhouette and clustering graphs
		...
		#		color = cm.spectral(float(j) / n_clusters)
			...
			#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\silhouette_plot_'+str(n_clusters)+'_'+str(stop_unique[i])+'.png', bbox_inches = 'tight')
			#plt.show()
		...
		plt.show()
		#plt.savefig('D:\\Masters\\Data Analysis and Data Mining\\Assignment 2\\Graphs\\elbow_plot_'+str(stop_unique[i])+'.png', bbox_inches = 'tight')
